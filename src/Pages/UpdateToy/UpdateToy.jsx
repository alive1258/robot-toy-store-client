...
const UpdateToy = () => {
    ...
    const { name, email, photo, toyName, subCategory, price, rating, quantity,description } = updateToys;
            ...
            <form onSubmit={handleUpdateToy}>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    ...
                    <div className="form-control">
                        ...
                        <input type="text" name='photo' defaultValue={photo} placeholder="URL of the Toy" className="input input-bordered" />
                    </div>
                    <div className="form-control">
                        <label className="label">
                            <span className="label-text">Toy Name</span>
                        </label>
                        <input type="text" name='toyName' defaultValue={toyName} placeholder="Toy Name" className="input input-bordered" />
                    ...
                    <div className="form-control">
                        ...
                        <input type="text" name='subCategory' defaultValue={subCategory} placeholder="Sub-category" className="input input-bordered" />
                    </div>
                    <div className="form-control">
                        <label className="label">
